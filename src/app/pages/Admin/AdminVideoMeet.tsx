...
export function AdminVideoMeet() {
  ...
  return (
    <div className="space-y-6">
      <BackButton to="/admin/chat" />

      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-white">Council Video Meeting</h1>
        <p className="text-gray-400 mt-2">Meet with club heads and review proposals</p>
      </div>
              ...
              <div className="mt-6 space-y-4">
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      type="text"
                      value="https://clubsphere.edu/meet/council-review-meeting"
                      readOnly
          ...
          <Card className="bg-[#111827] border-gray-800">
            ...
            <CardContent className="space-y-4">
              <div className="p-4 bg-purple-600/10 border border-purple-600/30 rounded-lg">
                <h3 className="text-white font-semibold mb-2">Proposal Review Session</h3>
                <p className="text-sm text-gray-400">Scheduled for today at 4:00 PM</p>
              </div>
                    ...
                    <div key={participant.id} className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-800">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center ${
                          participant.role.includes('Council') ? 'bg-purple-600' : 'bg-blue-600'
                        }`}
                      >
              ...
              <div className="pt-4 border-t border-gray-800">
                <h4 className="text-sm font-medium text-gray-300 mb-3">Host Settings</h4>
                <div className="space-y-2">
                  <label className="flex items-center justify-between">
                    <span className="text-sm text-gray-400">Mute participants on entry</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-gray-700 bg-gray-800" />
                  </label>
                  <label className="flex items-center justify-between">
                    <span className="text-sm text-gray-400">Enable waiting room</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-gray-700 bg-gray-800" />
                  </label>
                  <label className="flex items-center justify-between">
                    <span className="text-sm text-gray-400">Record meeting</span>
                    <input
                      type="checkbox"
                      defaultChecked
            ...
            <CardContent className="p-4">
                    ...
                    {participant.isVideoOn ? (
                      <div
                        className={`w-full h-full flex items-center justify-center ${
                          participant.role.includes('Council')
                ...
                <div className="mb-4 p-4 bg-blue-600/10 border border-blue-600/30 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">All participants can see your screen</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="mt-4 flex items-center justify-between px-4 py-3 bg-gray-800 rounded-lg">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm text-gray-400">Meeting Time: 00:22:47</span>
